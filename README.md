...
```
  ...
  [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/helloIamcopycat/iamcloning)

</details>  
<details>
  <summary>Steps to self Host!! </summary>

Note: This instruction set is just a copy-paste from Marie, note that [Yui-Chan Support](https://t.me/YuiiChanSupport) aims to handle support for @SaitamaRobot and not how to set up your own fork. If you find this bit confusing/tough to understand then we recommend you ask a dev, kindly avoid asking how to set up the bot instance in the support chat, it aims to help our own instance of the bot and not the forks.
...
For queries or any issues regarding the bot please open an issue ticket or visit us at [Yui-Chan Support](https://t.me/YuiiChanSupport)
...
Should any be missing kindly let us know at [Yui-Chan Support](https://t.me/YuiiChanSupport) or simply submit a pull request on the readme.
